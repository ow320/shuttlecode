...
function defaultState() {
  return {
    ...
    progress: {
      ...
      contentOverrides: {}, // exerciseId -> {goal, description, videoUrl, coachingPoints, commonMistakes, workout} — user edits layered on built-in exercises
      ...
      students: [], // coach's roster: [{id, name, level, notes, createdAt}]
    },
  };
}
